...
// Create env.ts file
const envTsContent = `import { z } from 'zod';
...
const envTsPath = path.join(configDir, 'env.ts');
fs.writeFileSync(envTsPath, envTsContent);
console.log('✓ Created env.ts file');

console.log('\n✅ Environment setup complete!');
console.log('\nFiles created:');
console.log('  - apps/backend/.env.example');
console.log('  - apps/backend/.env');
console.log('  - apps/backend/src/config/env.ts');
console.log('  - apps/frontend/.env.example');
