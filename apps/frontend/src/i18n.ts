...
const resources = {
  ...
  ar: {
    translation: {
      "home_title": "طلب رخصة الاستعمال",
      "home_description": "يرجى ملء النموذج أدناه لطلب رخصة لجهازك.",
      "license_request": "طلب رخصة",
      "submit_request": "أرسل طلب للحصول على رخصة جهاز جديد.",
      "name": "الاسم الكامل",
      "name_placeholder": "محمد بوعلام",
      "shop_name": "اسم المحل (الحانوت)",
      "shop_name_placeholder": "محل تجاري",
      "phone_number": "رقم الهاتف",
      "phone_placeholder": "06XXXXXXXX",
      "number_of_cashiers": "عدد أجهزة الكاشير",
      "machine_id": "معرّف الجهاز (Machine ID)",
      "machine_id_placeholder": "XXXX-XXXX-XXXX-XXXX",
      "machine_id_description": "يمكنك العثور على معرّف الجهاز في إعدادات النظام الخاصة بجهازك.",
      "security_check": "التحقق الأمني",
      "submitting": "جاري الإرسال...",
      "submit_button": "إرسال الطلب",
      "error": "خطأ",
      "check_form_errors": "يرجى التأكد من صحة المعلومات في النموذج.",
      "unknown_error": "حدث خطأ غير متوقع.",
      "failed_to_submit": "فشل إرسال الطلب. يرجى إعادة المحاولة.",
      "approved": "تم قبول طلب الرخصة!",
      "approved_description": "تم إنشاء رخصتك بنجاح. يرجى الاحتفاظ بهذا الكود في مكان آمن.",
      "expires_on": "صالحة إلى غاية",
      "request_another": "طلب رخصة أخرى",
      "copy_to_clipboard": "نسخ الكود",
      "validation": {
        "name_min": "الاسم يجب أن يتكون من حرفين على الأقل",
        "name_max": "الاسم يجب أن لا يتجاوز 100 حرف",
        "name_invalid": "الاسم يحتوي على رموز غير مسموح بها",
        "machine_id_required": "معرّف الجهاز مطلوب",
        "machine_id_max": "معرّف الجهاز طويل جداً",
        "machine_id_alphanumeric": "معرّف الجهاز يجب أن يحتوي على حروف وأرقام فقط",
        "phone_invalid": "رقم الهاتف غير صحيح (يرجى إدخال رقم هاتف جزائري صحيح)",
        "shop_name_min": "اسم المحل يجب أن يتكون من حرفين على الأقل",
        "shop_name_max": "اسم المحل يجب أن لا يتجاوز 100 حرف",
        "shop_name_invalid": "اسم المحل يحتوي على رموز غير مسموح بها",
        "cashiers_integer": "عدد أجهزة الكاشير يجب أن يكون عدداً صحيحاً",
        "cashiers_min": "عدد أجهزة الكاشير يجب أن يكون 1 على الأقل",
        "cashiers_max": "عدد أجهزة الكاشير لا يمكن أن يتجاوز 50",
        "captcha_required": "يرجى تأكيد أنك لست روبوت"
      }
    }
  },
  es: {
