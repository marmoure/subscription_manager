...
CREATE TABLE `__new_admin_users` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T12:25:13.837Z"' NOT NULL,
...
CREATE TABLE `__new_license_keys` (
	...
	`created_at` integer DEFAULT '"2026-01-25T12:25:13.837Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-25T12:25:13.837Z"' NOT NULL,
	`expires_at` integer
);
--> statement-breakpoint
...
CREATE TABLE `__new_user_submissions` (
	...
	`submission_date` integer DEFAULT '"2026-01-25T12:25:13.837Z"' NOT NULL,
	`ip_address` text,
...
CREATE TABLE `__new_users` (
	...
	`name` text NOT NULL,
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T12:25:13.836Z"' NOT NULL
);
--> statement-breakpoint
