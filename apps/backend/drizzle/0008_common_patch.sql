CREATE TABLE `license_status_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2026-01-25T16:19:26.296Z"' NOT NULL,
...
CREATE TABLE `__new_admin_users` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T16:19:26.296Z"' NOT NULL,
...
CREATE TABLE `__new_api_keys` (
	...
	`key` text NOT NULL,
	`name` text,
	`created_at` integer DEFAULT '"2026-01-25T16:19:26.295Z"' NOT NULL,
...
CREATE TABLE `__new_license_keys` (
	...
	`created_at` integer DEFAULT '"2026-01-25T16:19:26.295Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-25T16:19:26.295Z"' NOT NULL,
	`expires_at` integer
);
--> statement-breakpoint
...
CREATE TABLE `__new_user_submissions` (
	...
	`submission_date` integer DEFAULT '"2026-01-25T16:19:26.295Z"' NOT NULL,
	`ip_address` text,
...
CREATE TABLE `__new_users` (
	...
	`name` text NOT NULL,
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T16:19:26.294Z"' NOT NULL
);
--> statement-breakpoint
