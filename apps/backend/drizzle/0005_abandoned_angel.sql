...
CREATE TABLE `__new_admin_users` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T14:59:47.858Z"' NOT NULL,
...
CREATE TABLE `__new_api_keys` (
	...
	`key` text NOT NULL,
	`name` text,
	`created_at` integer DEFAULT '"2026-01-25T14:59:47.857Z"' NOT NULL,
...
CREATE TABLE `__new_license_keys` (
	...
	`created_at` integer DEFAULT '"2026-01-25T14:59:47.857Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-25T14:59:47.857Z"' NOT NULL,
	`expires_at` integer
);
--> statement-breakpoint
...
CREATE TABLE `__new_user_submissions` (
	...
	`submission_date` integer DEFAULT '"2026-01-25T14:59:47.857Z"' NOT NULL,
	`ip_address` text,
...
CREATE TABLE `__new_users` (
	...
	`name` text NOT NULL,
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T14:59:47.856Z"' NOT NULL
);
--> statement-breakpoint
