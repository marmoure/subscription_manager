CREATE TABLE `verification_logs` (
	...
	`message` text,
	`ip_address` text,
	`timestamp` integer DEFAULT '"2026-01-25T16:05:52.303Z"' NOT NULL,
...
CREATE INDEX `verification_logs_timestamp_idx` ON `verification_logs` (`timestamp`);--> statement-breakpoint
...
CREATE TABLE `__new_admin_users` (
	...
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T16:05:52.303Z"' NOT NULL,
	`last_login_at` integer,
	`is_active` integer DEFAULT true NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_admin_users`("id", "username", "hashed_password", "email", "created_at", "last_login_at", "is_active") SELECT "id", "username", "hashed_password", "email", "created_at", "last_login_at", "is_active" FROM `admin_users`;--> statement-breakpoint
...
CREATE TABLE `__new_license_keys` (
	...
	`created_at` integer DEFAULT '"2026-01-25T16:05:52.303Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-25T16:05:52.303Z"' NOT NULL,
	`expires_at` integer
);
--> statement-breakpoint
INSERT INTO `__new_license_keys`("id", "license_key", "machine_id", "status", "created_at", "updated_at", "expires_at") SELECT "id", "license_key", "machine_id", "status", "created_at", "updated_at", "expires_at" FROM `license_keys`;--> statement-breakpoint
...
CREATE TABLE `__new_user_submissions` (
	...
	`submission_date` integer DEFAULT '"2026-01-25T16:05:52.303Z"' NOT NULL,
	`ip_address` text,
...
CREATE TABLE `__new_users` (
	...
	`name` text NOT NULL,
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-25T16:05:52.302Z"' NOT NULL
);
--> statement-breakpoint
