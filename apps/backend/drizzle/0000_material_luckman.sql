CREATE TABLE `admin_users` (
	...
	`created_at` integer DEFAULT '"2026-01-26T20:18:36.304Z"' NOT NULL,
...
CREATE TABLE `license_keys` (
	...
	`created_at` integer DEFAULT '"2026-01-26T20:18:36.304Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-26T20:18:36.304Z"' NOT NULL,
	`expires_at` integer,
	`revoked_at` integer
);
--> statement-breakpoint
...
CREATE TABLE `license_status_logs` (
	...
	`reason` text,
	`timestamp` integer DEFAULT '"2026-01-26T20:18:36.304Z"' NOT NULL,
...
CREATE UNIQUE INDEX `token_idx` ON `refresh_tokens` (`token`);--> statement-breakpoint
CREATE INDEX `refresh_token_admin_id_idx` ON `refresh_tokens` (`admin_id`);--> statement-breakpoint
CREATE TABLE `user_submissions` (
	...
	`submission_date` integer DEFAULT '"2026-01-26T20:18:36.304Z"' NOT NULL,
	`ip_address` text,
...
CREATE TABLE `users` (
	...
	`name` text NOT NULL,
	`email` text NOT NULL,
	`created_at` integer DEFAULT '"2026-01-26T20:18:36.303Z"' NOT NULL
);
--> statement-breakpoint
